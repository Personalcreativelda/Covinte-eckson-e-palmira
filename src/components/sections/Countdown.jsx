  ...
  return (
    <section id="countdown" className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="text-4xl md:text-5xl font-serif font-bold text-center text-gray-800 mb-16">
          Contagem Regressiva
        </h2>
          ...
          {units.map(u => (
            <div key={u.label} className="text-center">
              <div className="bg-rose-50 rounded-2xl p-8 shadow-lg">
                <div className="text-5xl font-bold text-rose-600 mb-2">{u.value}</div>
                <div className="text-gray-600 font-medium">{u.label}</div>
              </div>
            </div>
          ))}
        </div>
